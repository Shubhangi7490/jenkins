...
factory.job('jenkins-pipeline-cf-seed') {
	...
	wrappers {
		...
		parameters {
			...
			stringParam('REPO_WITH_BINARIES_FOR_UPLOAD', 'https://artifactory:8081/artifactory/libs-release-local', "Address to hosted JARs for uploading")
			...
			stringParam('PAAS_TEST_SPACE', 'cloudpipelines-test', 'Name of the CF space for the test env')
