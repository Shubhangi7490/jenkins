...
final class EnvironmentVariables {
	 ...
	 * {@code cloud-pipelines.yml}
	 */
	public static final String PIPELINE_DESCRIPTOR_ENV_VAR = "PIPELINE_DESCRIPTOR"

	/**
	 * {@code LEGACY_PIPELINE_DESCRIPTOR} - name of the legacy pipeline descriptor. Defaults to
	 * {@code sc-pipelines.yml}. Will be used as a fallback if the {@code PIPELINE_DESCRIPTOR}
	 * is not found
	 */
	public static final String LEGACY_PIPELINE_DESCRIPTOR_ENV_VAR = "LEGACY_PIPELINE_DESCRIPTOR"
